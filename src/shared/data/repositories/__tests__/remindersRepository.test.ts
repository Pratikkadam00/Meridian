...
describe("reminder date logic", () => {
  it("schedules reminder offsets at 09:00 Asia/Dubai (05:00 UTC), matching the SQL scheduler", () => {
    expect(computeReminderSendAt("2026-06-19", 3)).toBe("2026-06-16T05:00:00.000Z");
    expect(computeReminderSendAt("2026-01-02", 7)).toBe("2025-12-26T05:00:00.000Z");
  });
